...
const forgetPassword = async (req, res) => {
  ...
  if (!isAdded) {
    ...
    const body = {
      ...
      <p>A request has been received to change the password for your <strong>Hardware & Interior Studio</strong> account </p>
        ...
        <p style="margin-top: 35px;">If you did not initiate this request, please contact us immediately at support@Hardware & Interior Studio.com</p>

        <p style="margin-bottom:0px;">Thank you</p>
        <strong>Hardware & Interior Studio Team</strong>
             `,
    };
...
const resetPassword = async (req, res) => {
  ...
  const staff = await Admin.findOne({ email: decodedToken.email });
  if (!staff) {
  ...
  try {
    ...
    if (isAdded) {
      ...
      const newStaff = new Admin({
        ...
        joiningData: req.body.joiningDate,
        role: req.body.role,
