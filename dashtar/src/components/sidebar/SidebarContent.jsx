...
const SidebarContent = () => {
  ...
  return (
    <div className="py-4 text-gray-500 dark:text-gray-400">
      <a className="block text-gray-900 dark:text-gray-200" href="/dashboard">
        <h1 className="pl-6 py-1 text-2xl font-bold tracking-tight text-emerald-600 dark:text-emerald-400">
          Admin<span className="text-gray-800 dark:text-gray-100"> Panel</span>
        </h1>
      </a>
      <ul className="mt-8">
