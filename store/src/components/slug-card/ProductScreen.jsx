        ...
        <div className="container mx-auto px-3 sm:px-10 max-w-screen-2xl">
          <div className="flex items-center py-6 lg:py-8">
            <ol className="flex items-center w-full overflow-hidden ">
              <li className="text-sm pr-1 transition duration-200 ease-in cursor-pointer hover:text-black font-semibold">
                <Link href="/">Home</Link>
              </li>
              ...
              <li className="text-sm pl-1 transition duration-200 ease-in cursor-pointer hover:text-black font-semibold ">
                <Link
...
<div className="lg:col-span-3 lg:row-end-1">
  {/* Image gallery */}
  <div
    className="overflow-hidden w-full mx-auto group relative rounded-md bg-gray-100"
    onMouseMove={(e) => {
      const { left, top, width, height } = e.currentTarget.getBoundingClientRect();
      const x = ((e.pageX - left) / width) * 100;
      const y = ((e.pageY - top) / height) * 100;
      e.currentTarget.style.backgroundSize = "200%"; // zoom in
      e.currentTarget.style.backgroundPosition = `${x}% ${y}%`;
    }}
    onMouseLeave={(e) => {
      e.currentTarget.style.backgroundSize = "100%"; // reset zoom
      e.currentTarget.style.backgroundPosition = "center"; // reset position
    }}
    style={{
      backgroundImage: `url(${selectedImage || product.image?.[0] || "https://res.cloudinary.com/ahossain/image/upload/v1655097002/placeholder_kvepfp.png"})`,
      backgroundRepeat: "no-repeat",
      backgroundSize: "100%", // start normal
      backgroundPosition: "center",
      transition: "background-size 0.4s ease, background-position 0.4s ease", // smooth animation
    }}
  >
    {/* Keep actual image hidden for SEO & fallback */}
    <Image
      src={selectedImage || product.image?.[0] || "https://res.cloudinary.com/ahossain/image/upload/v1655097002/placeholder_kvepfp.png"}
      alt="product"
      width={500}
      height={500}
      priority
            ...
            <div className="lg:sticky top-44 mt-6 lg:mt-0 self-start z-10 mx-auto lg:col-span-4 lg:row-span-2 lg:row-end-2 lg:max-w-none">
              ...
              <div>
                ...
                <div className="flex items-center text-sm text-gray-500 mt-3">
                  ...
                  Call Us for Order
                  <a
                    href={`tel:${globalSetting?.phone || "+91 9845382051"}`}
                    className="font-bold text-black ml-1"
                  >
                    {globalSetting?.phone || "+91 9845382051"}
                  </a>
                </div>
                ...
                <div className="mt-6 border-t border-gray-200 pt-6">
                  ...
                  <ul role="list" className="mt-4 flex items-center space-x-6">
                    <li>
                      <FacebookShareButton
                        url={`https://Hardware & Interior Studio-store-nine.vercel.app/product/${product?.slug}`}
                      >
                        <a
                          href="#"
