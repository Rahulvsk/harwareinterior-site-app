...
const CheckoutButton = ({ stripe, isEmpty, storeCustomizationSetting }) => {
  ...
  return (
    <button
      ...
      className="bg-black hover:bg-emerald-600 border cursor-pointer border-black transition-all rounded py-3 text-center text-sm font-medium text-white flex justify-center w-full"
    >
      {pending ? (
