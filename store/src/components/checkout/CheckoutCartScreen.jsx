                  ...
                  {couponInfo.couponCode ? (
                    ...
                    <div className="flex flex-row items-start justify-end w-full">
                      <Input
                        ...
                        // className="form-input py-2 px-3 md:px-4 w-full appearance-none transition ease-in-out border text-input text-sm rounded-md h-12 duration-200 bg-white border-gray-200 focus:ring-0 focus:outline-none focus:border-black placeholder-gray-500 placeholder-opacity-75"
                      />
                      <Button
            ...
            <div className="bg-neutral-100 dark:bg-slate-900 p-8 rounded-b-md">
              ...
              <div className="flex space-x-3 items-center mt-8">
                ...
                <Link
                  ...
                  className="relative h-auto inline-flex items-center justify-center rounded-md w-full transition-colors text-xs sm:text-base font-medium py-2 px-3 bg-black hover:bg-emerald-600 border border-black text-white flex-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-6000 dark:focus:ring-offset-0 "
                >
                  Checkout
                </Link>
              </div>
