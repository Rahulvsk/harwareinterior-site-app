                                ...
                                <td className="px-4 text-sm whitespace-nowrap text-end">
                                  {link ? (
                                    <Link href={`/order/${order._id}`}>
                                      <span className="text-black text-end cursor-pointer hover:text-black transition-all p-3 font-semibold rounded-full flex items-center justify-end gap-1.5">
                                    ...
                                    <span
                                      ...
                                      className="text-black text-end cursor-pointer hover:text-black transition-all p-3 font-semibold rounded-full flex items-center justify-end gap-1.5"
                                    >
                                      <Eye className="h-4 w-4" />
                                    </span>
                                  )}
