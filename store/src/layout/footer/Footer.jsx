          ...
          {footer?.block2_status && (
            <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3">
              ...
              <ul className="text-sm lg:text-15px flex flex-col space-y-3">
                <li className="flex items-baseline">
                <Link
              href="/search?category=laminate&_id=68c42a646d333a98baa8328b"
              className="text-gray-600 inline-block w-full hover:text-black"
            >
              Laminate
                  {/* <Link
...
<Link
                    href={`/search?category=louvers&_id=632aca6d4d87ff2494210c24`}
                    className="text-gray-600 inline-block w-full hover:text-black"
                  >
...
<Link
                    href={`/search?category=handles&_id=632aae414d87ff249421`}
                    className="text-gray-600 inline-block w-full hover:text-black"
                  >
                ...
                <li className="flex items-baseline">
                  ...
                  > */}
                  <Link
                    href={`/search?category=plywood-and-boards&_id=632ab14a4d87ff2494210a29`}
                    className="text-gray-600 inline-block w-full hover:text-black"
                  >
                    Plywoods
                    {/* <CMSkeletonTwo
