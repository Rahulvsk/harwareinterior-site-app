export const storeCustomization = {
  ...
  home: {
    ...
    quick_delivery_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from our Hardware & Interior Studio shop and get some special offers. See Our latest discounted products from here and get a special discount.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem Hardware & Interior Studio-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
    },
    ...
    daily_need_title: {
      en: "Get Your Daily Needs From Our Hardware & Interior Studio Store",
      de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
    },
    daily_need_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from our Hardware & Interior Studio shop and get some special offers.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem Hardware & Interior Studio-Shop und erhalten Sie einige Sonderangebote.",
    },
  ...
  about_us: {
    ...
    founder_status: true,
    header_bg:
      "https://res.cloudinary.com/dqsbaiebh/image/upload/v1758301790/hliehjlcgaejzjgxv0g4.jpg",
    content_right_img:
    ...
    top_title: {
      en: "Welcome to our Hardware & Interior Studio shop",
      de: "Willkommen in unserem Hardware & Interior Studio-Shop",
    },
    top_description: {
  ...
  contact_us: {
    ...
    email_box_email: {
      en: "info@Hardware & Interior Studio.com ",
      de: "info@Hardware & Interior Studio.com",
    },
    email_box_text: {
  ...
  faq: {
    ...
    faq_one: {
      en: "How does the Hardware & Interior Studio work?",
      de: "Wie funktioniert der Hardware & Interior Studio?",
    },
    description_one: {
    ...
    faq_five: {
      en: "What is Hardware & Interior Studio EC2 auto scaling?",
      de: "Was ist die automatische Skalierung von Hardware & Interior Studio EC2?",
    },
    description_five: {
      en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
    ...
    faq_six: {
      en: "What are the benefits of using Hardware & Interior Studio affliate?",
  ...
  seo: {
    ...
    meta_title:
      "Hardware & Interior Studio - React Grocery & Organic Food Store e-commerce Template",
    meta_url: "https://Hardware & Interior Studio-store-nine.vercel.app/",
  },
};
