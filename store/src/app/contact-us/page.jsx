...
export const metadata = {
  title: "Contact Us | Hardware & Interior Studio",
  description:
  ...
  openGraph: {
    ...
    description:
      "Get in touch with us! Find our contact information and fill out our contact form.",
    url: "https://Hardware & Interior Studio-store-nine.vercel.app/contact-us",
    images: [
      {
        url: "https://Hardware & Interior Studio-store-nine.vercel.app/og-image.jpg",
        width: 800,
        height: 600,
        alt: "Contact Us Page",
      },
          ...
          <div className="grid md:grid-cols-2 gap-6 lg:grid-cols-3 xl:gap-8 ">
            {error ? (
              ...
              <div className="border p-10 rounded-lg text-center">
                <span className="flex justify-center text-4xl text-black mb-4">
                  <FiMail />
                </span>
                  ...
                  <div className="flex flex-col md:flex-row space-y-5 md:space-y-0">
                    <div className="w-full md:w-1/2 ">
                      <input
                        ...
                        className="py-2 px-4 md:px-5 w-full appearance-none border text-sm opacity-75 text-input rounded-md placeholder-body min-h-12 transition duration-200 focus:ring-0 ease-in-out bg-white border-gray-200 focus:outline-none focus:border-black h-11 md:h-12"
                      />
