...
export const metadata = {
  title: "About Us | Hardware & Interior Studio",
  description:
  ...
  openGraph: {
    ...
    description:
      "Get in touch with us! Find our contact information and fill out our contact form.",
    url: "https://Hardware & Interior Studio-store-nine.vercel.app/about-us",
    images: [
      {
        ...
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-4 sm:px-10">
          <div className="grid grid-flow-row lg:grid-cols-2 gap-4 lg:gap-16 items-center">
            ...
            <div className="mt-10 lg:mt-0">
              <Image
                width={920}
                height={750}
                src="https://res.cloudinary.com/dqsbaiebh/image/upload/v1758305412/xfu87jg9vir2xfq1xrxj.png"
                alt="logo"
                style={{borderRadius:"5px",boxShadow:"rgba(100, 100, 111, 0.2) 0px 7px 29px 0px"}}
              />
            </div>
          </div>
          ...
          <div className="mt-10 lg:mt-12 flex flex-col sm:grid gap-4">
            <Image
              width={1920}
              height={570}
              src="https://res.cloudinary.com/dqsbaiebh/image/upload/v1758307080/ghutnn3tpzjfgcgr05lr.jpg"
              alt="logo"
